        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    sota_common_1.registerMailEventCallback(function (messages) { return __awaiter(_this, void 0, void 0, function () {
                        var appName, receiver, sender, senderName;
                        var _this = this;
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                                        ...
                                                        return [4, rawdb_1.insertMailJob(manager, props)];
                                                    case 1:
                                                        _a.sent();
                                                        return [2];
                                                }
