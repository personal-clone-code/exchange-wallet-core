...
exports.getNextPickedWithdrawals = void 0;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4, manager.getRepository(entities_1.Withdrawal).findOne({
                            order: { updatedAt: 'ASC' },
                            where: {
                                currency: typeorm_1.In(platformCurrencies),
...
exports.getNextPickedWithdrawals = getNextPickedWithdrawals;
//# sourceMappingURL=getNextPickedWithdrawals.js.map