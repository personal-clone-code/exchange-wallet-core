...
exports._lowerThresholdHandle = exports.checkAddressIsSufficient = exports.checkHotWalletIsSufficient = exports.lowerThresholdHandle = exports.upperThresholdHandle = exports.checkUpperThreshold = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, _lowerThresholdHandle(manager, sentRecord, hotWallet, sentRecord.currency)];
                case 2:
                    _a.sent();
                    currency = sota_common_1.CurrencyRegistry.getOneCurrency(sentRecord.currency);
                    if (!!currency.isNative) return [3, 4];
                    return [4, _lowerThresholdHandle(manager, sentRecord, hotWallet, currency.platform)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [2];
...
function _lowerThresholdHandle(manager, sentRecord, hotWallet, currency) {
    return __awaiter(this, void 0, void 0, function () {
        var currencyConfig, lower, gateway, balance, pending, appName, sender, senderName, receiver;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, rawdb.findOneCurrency(manager, currency, sentRecord.walletId)];
                case 1:
                ...
                case 2:
                    balance = _a.sent();
                    return [4, rawdb.findWithdrawalsPendingBalance(manager, hotWallet.walletId, hotWallet.userId, currency, hotWallet.address)];
                case 3:
                    pending = _a.sent();
                    balance = balance.minus(pending);
                    if (lower.eq(0) || balance.gt(lower)) {
                        logger.info("Hot wallet symbol=" + currency + " address=" + hotWallet.address + " is not in lower threshold, ignore notifying");
                        return [2];
                    }
...
exports._lowerThresholdHandle = _lowerThresholdHandle;
