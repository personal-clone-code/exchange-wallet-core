...
exports.updateLocalTxStatus = void 0;
var entities_1 = require("../entities");
function updateLocalTxStatus(manager, id, status, transactionResult, fee, blockHeader) {
    return __awaiter(this, void 0, void 0, function () {
        var record;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, manager.findOne(entities_1.LocalTx, id)];
                case 1:
                    record = _a.sent();
...
exports.updateLocalTxStatus = updateLocalTxStatus;
//# sourceMappingURL=updateLocalTxStatus.js.map