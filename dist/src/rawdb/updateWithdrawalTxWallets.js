            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    tasks = _.map(withdrawals, function (record) { return __awaiter(_this, void 0, void 0, function () {
                        var balanceChange, walletBalance, walletLog;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    if (event === Enums_1.WithdrawalEvent.COMPLETED) {
                                        ...
                                        if (currency.isNative) {
                                            balanceChange = '-' + new sota_common_1.BigNumber(record.amount).minus(fee).toString();
                                        }
                                        else {
                                    ...
                                    return [4, sota_common_2.Utils.PromiseAll([
                                            manager
                                                ...
                                                balance: function () {
                                                    if (event === Enums_1.WithdrawalEvent.COMPLETED) {
                                                        if (currency.isNative) {
                                                            return "balance - " + new sota_common_1.BigNumber(record.amount).minus(fee).toString();
                                                        }
