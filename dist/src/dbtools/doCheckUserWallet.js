...
exports.doCheckUserWallet = void 0;
var _ = __importStar(require("lodash"));
var typeorm_1 = require("typeorm");
var sota_common_1 = require("sota-common");
var entities_1 = require("../entities");
var logger = sota_common_1.getLogger('DBTools::# UserWallet::');
function doCheckUserWallet() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, typeorm_1.getConnection().transaction(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, _doCheckUserWallet(manager)];
                                case 1:
                                    _a.sent();
                                    return [2];
                            }
...
exports.doCheckUserWallet = doCheckUserWallet;
function _doCheckUserWallet(manager) {
    return __awaiter(this, void 0, void 0, function () {
        var userWalletErrors, users, currencyConfigs, tasks;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
//# sourceMappingURL=doCheckUserWallet.js.map