...
exports.doCheckCurrencyConfig = void 0;
var _ = __importStar(require("lodash"));
var typeorm_1 = require("typeorm");
var sota_common_1 = require("sota-common");
var entities_1 = require("../entities");
var logger = sota_common_1.getLogger('DBTools::# CurrencyConfig::');
function doCheckCurrencyConfig() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, typeorm_1.getConnection().transaction(function (manager) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, _doCheckCurrencyConfig(manager)];
                                case 1:
                                    _a.sent();
                                    return [2];
                            }
...
exports.doCheckCurrencyConfig = doCheckCurrencyConfig;
function _doCheckCurrencyConfig(manager) {
    return __awaiter(this, void 0, void 0, function () {
        var currencyConfigErrors, users, currencyConfigs, tasks;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                            ...
                            switch (_a.label) {
                                case 0:
                                    subTasks = _.map(currencyConfigs, function (config) { return __awaiter(_this, void 0, void 0, function () {
                                        var currenciesOfPlatform, currencyTasks;
                                        var _this = this;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    currenciesOfPlatform = sota_common_1.CurrencyRegistry.getCurrenciesOfPlatform(config.currency);
                                                    currencyTasks = _.map(currenciesOfPlatform, function (currency) { return __awaiter(_this, void 0, void 0, function () {
                                                        var result;
                                                        return __generator(this, function (_a) {
                                                            switch (_a.label) {
                                                                case 0: return [4, manager.getRepository(entities_1.Currency).findOne({
                                                                        userId: user.id,
                                                    ...
                                                    return [4, Promise.all(currencyTasks)];
                                                case 1:
                                                    _a.sent();
                                                    return [2];
                                            }
...
//# sourceMappingURL=doCheckCurrencyConfig.js.map