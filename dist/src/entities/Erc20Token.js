...
var Erc20Token = (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Erc20Token.prototype, "contractAddress", void 0);
    __decorate([
        typeorm_1.Column({ name: 'decimal', nullable: false }),
        __metadata("design:type", Number)
    ], Erc20Token.prototype, "decimal", void 0);
    __decorate([
        typeorm_1.Column({ name: 'total_supply', nullable: false }),
        __metadata("design:type", String)
    ], Erc20Token.prototype, "totalSupple", void 0);
    __decorate([
        typeorm_1.Column({ name: 'network', nullable: false }),
        __metadata("design:type", String)
    ], Erc20Token.prototype, "network", void 0);
    Erc20Token = __decorate([
        typeorm_1.Entity('erc20_token')
    ], Erc20Token);
    return Erc20Token;
}());
